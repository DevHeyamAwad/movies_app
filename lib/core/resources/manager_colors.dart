...
class ManagerColors {
  ...
  static const Color pink = Color(0xffDB3069);
  ...
  static const Color movieTitleColor = Colors.black;

  static const Color iconButtonNavigationBar = Color(0xff999999);
  static const Color moreButtonColor = Color(0xFFFECB2F);
